    ...
    const getDocs = async() => {
        try {
            ...
            return fetch(`${configData.TEST_URL}/document/singleDocument/${id}`, {
                ...
                .then((responseJson) => {
                    console.log((responseJson.data.clientId));
                ...
                <div className="col-md-12">
                         <h4 className="mt-4 text-center">PROPERTY DETAILS </h4>
                            <div className="row g-2">
                                     <div className="col-md">
                                        <div class="form-floating">
                                            <select className="form-select mt-3" name="estateId" ref={register({ required: true })}   defaultValue={docs ? docs?.estateId?.name : ''}
                            ...
                            <div className="row g-2">
                                ...
                                <div className="col-md">
                                        <div className="form-floating mt-3">
                                            <input placeholder="Commission" type="number" className="h-auto form-control " name="commission" ref={register({ required: true })} defaultValue={docs ? docs?.commission : ''}/>
